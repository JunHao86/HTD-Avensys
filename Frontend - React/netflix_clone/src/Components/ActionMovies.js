...
export function ActionMovies() {
    ...
    useEffect(function(){
        get("https://api.themoviedb.org/3/discover/movie?api_key=7698c174ffb539d18437d31eba0ecbde&with_genres=28")
    ...
    return (
    <div>
        <div className="image-container" style={{display:"flex", overflowX: "auto" }}>
        {
